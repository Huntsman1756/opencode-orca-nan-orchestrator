...
cmd_dep_tree() {
    ...
    END {
        ...
        while (print_sp > 0) {
            ...
            if (connector == "Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ ") new_prefix = prefix "    "
            else new_prefix = prefix "Ã¢â€â€š   "
    ...
    function build_children(id, depth, prefix, connector, path,    i, child, n, arr, sorted, j, tmp, min_idx) {
        ...
        for (i = n; i >= 1; i--) {
            ...
            if (i == n) print_stack_conn[print_sp] = "Ã¢â€â€Ã¢â€â‚¬Ã¢â€â‚¬ "
            else print_stack_conn[print_sp] = "Ã¢â€Å“Ã¢â€â‚¬Ã¢â€â‚¬ "
